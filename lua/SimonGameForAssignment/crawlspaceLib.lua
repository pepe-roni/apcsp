...
local displayMethods = function( obj )
    ...
    d.fadeOut = function( self, time, callback, autoRemove) 
    	...
    	tranc(d.fader); 
    	d.fader=transition.to(d, {alpha=0, time=time or d.fadeTime or 500, onComplete=d.callback}) 
    end
...
helpArr.cancelAll = 'timer.cancelAllCSL()'
timer.cancelAllCSL = function()
...
local debugger = function()
    DebugVar("debugTime", {1000, 10000}, 5000, "Debug Timer")
